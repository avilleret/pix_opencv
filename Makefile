...
LIBS_linux += lib-$(EXTENSION)/libopencv_calib3d.so.2.4 lib-$(EXTENSION)/libopencv_core.so.2.4 lib-$(EXTENSION)/libopencv_features2d.so.2.4 lib-$(EXTENSION)/libopencv_flann.so.2.4 lib-$(EXTENSION)/libopencv_gpu.so.2.4 lib-$(EXTENSION)/libopencv_highgui.so.2.4 lib-$(EXTENSION)/libopencv_imgproc.so.2.4 lib-$(EXTENSION)/libopencv_legacy.so.2.4 lib-$(EXTENSION)/libopencv_ml.so.2.4 lib-$(EXTENSION)/libopencv_nonfree.so.2.4 lib-$(EXTENSION)/libopencv_objdetect.so.2.4 lib-$(EXTENSION)/libopencv_ocl.so.2.4 
